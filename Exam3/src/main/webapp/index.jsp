<%@page import="com.icreon.demo.helper.MyConnection"%>
	 ...
	 <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    ...
                    <p>Welcome to Online Dictionary, An online dictionary is a dictionary that is accessible via the Internet through a web browser. They can be made available in a number of ways: free, free with a paid subscription for extended or more professional content, or a paid-only service.
                     Many dictionaries have been digitized from their print versions and are available at online libraries. 
                    ...
                    <a href="login_page.jsp" class="btn btn-outline-light btn-lg"> <span class="fa fa-user-circle fa"></span>  Login</a>
