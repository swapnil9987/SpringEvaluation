...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="dictionary.jsp" > <span class="fa fa-user "></span> Dictionary </a>
                    </li>
                    
                    
        			 <li class="nav-item">
                        <a class="nav-link" href="UserDisplayAdmin" > <span class="fa fa-user-circle "></span> See all users </a>
                    </li>
                    <li class="nav-item">
